...
module.exports = {
  ...
  networks: {
    ...
    rinkeby: {
      provider: () => new HDWalletProvider('blouse price start often ethics aim slender broccoli solution impose drill devote', 'wss://eth-rinkeby.alchemyapi.io/v2/fo1n0I2MhJV5blUzy557KP8CMuKN3YSX'),
      network_id: 4,
      gas: 600000000,
      // confirmations: 2,
      timeoutBlocks: 200,
